...
// Helper: run check and update counters
function runCheck(value, checkObj) {
  if (check(value, checkObj)) {
    testsPassed.add(1);
  } else {
    testsFailed.add(1);
  }
...
export default async function browserTests() {
